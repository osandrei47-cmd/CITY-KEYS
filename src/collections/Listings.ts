...
export const Listings: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        description:
          "Если загружено — на странице объекта появляется блок с видео (после фото) и бейдж «Видео с дрона» в каталоге. Подходит для любого видео объекта, не только с дрона",
      },
    },
